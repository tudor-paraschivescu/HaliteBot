...
public class MyBot {
    ...
    static {
        try {
            printStream = new PrintStream("logfile.txt");
    ...
    private static ArrayList<Move> getLocsAround(Location loc, int steps) {
        ...
        Collections.sort(arrayList, (o1, o2) -> calculateStrengthAfter(o2.loc, steps) -
    ...
    private static ArrayList<Move> tryToTakeOver(Location loc, int steps) {
        ...
        printStream.println(biggest.dir + " " + biggest.loc.getX() + " " + biggest.loc.getY());
    ...
    public static void main(String[] args) throws java.io.IOException {
        ...
        while (true) {
            ...
            PriorityQueue<Location> scores = new PriorityQueue<>((o1, o2) -> (int) (getScore(o2) - getScore(o1)));
            ...
            while (!scores.isEmpty()) {
                ...
                if (!((movesForEdge = tryToTakeOver(loc, 0)).size() == 0)) {
                    printStream.println(movesForEdge.get(0).dir + "!");
